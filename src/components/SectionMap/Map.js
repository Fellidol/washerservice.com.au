...
function Map() {
  ...
  const createSVGIcon = (color) => {
    return new L.DivIcon({
      html: `
      <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25px" height="25px" viewBox="0 0 512 512"  xml:space="preserve">
        <g>
          <path style="fill:${color} !important;" d="M256.016,0C158.797,0.031,80.094,78.781,80.063,175.953c0.063,14.297,3.031,28.641,7.563,43.797
          ...
          <path style="fill:${color} !important;"" d="M256.016,118.719c-31.594,0-57.219,25.641-57.219,57.234c0,31.609,25.625,57.219,57.219,57.219
